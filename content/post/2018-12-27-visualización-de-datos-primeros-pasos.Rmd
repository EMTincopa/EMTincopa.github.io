...
![Población mundial 1950-2100 - Power BI](\content\post\2018-12-27-visualización-de-datos-primeros-pasos\population_example.gif)
...
En cualquier caso, si finalmente te has decidido aprender R para sumergirte en la visualización de datos, te recomiendo que revises los paquetes [ggplot2](https://ggplot2.tidyverse.org/) y dplyr (si eres disciplinado podrás aprender la sintaxis de R en menos de un mes). Una vez aprendas la sintaxis, los gráficos de dispersión, barras y de burbujas, entre otros, serán muy fáciles. 

En general las visualizaciones que parecían extremadamente difíciles terminarán siendo más sencillas de lo que esperabas. Es a partir de este momento en el que tienes que hacer explotar tu creatividad, domina ggplot2 y dplyr porque serán tus principales herramientas para más adelante encontrar historias entre tus datos.


A continuación algunos gráficos hechos con R.

```{r pie, fig.cap='Gráfico de pie para un ícono piramidal.', tidy=FALSE}
par(mar = c(0, 1, 0, 1))
pie(
  c(280, 60, 20),
...
R no solo genera visualizaciones estáticas, actualmente gracias a la R API de [Plotly](https://plot.ly/#/) (una librería de código abierto de JavaScript) podemos crear gráficos interactivos basados en nuestros códigos en R.

<iframe width="640" height="320" frameborder="0" scrolling="no" src="//plot.ly/~EMTincopa/6.embed"></iframe>

Finalmente, tengo que decirte que R no es el único lenguaje con el cual podrás crear visualizaciones impactantes. Python, por ejemplo, tiene muchas librerías dedicadas a la visualización de datos ([Seaborn](https://seaborn.pydata.org/) y [Bokeh](https://bokeh.pydata.org/en/latest/)) y JavaScript con su librería D3 es la elección indicada si quieres publicar en la web gráficos interactivos.
...
![Población mundial 1950-2100 - Power BI](https://www.youtube.com/watch?v=39cypVFGOKk)
